...
from boltzina.affinity.run import calc_from_data
from boltzina.boltz.main import get_cache_path
...
class Boltzina:
    ...
    def run_vina_docking(self, ligand_files: List[str], ligand_format: str = "sdf") -> None:
...
def main():
    ...
    # Run the pipeline
    boltzina.run_vina_docking(args.ligands, args.ligand_format)
